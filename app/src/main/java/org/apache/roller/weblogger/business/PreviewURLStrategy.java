...
public class PreviewURLStrategy extends MultiWeblogURLStrategy {
    ...
    public String getWeblogCollectionURL(Weblog weblog, String locale, String category, String dateString, List<String> tags, int pageNum, boolean absolute) {
        ...
        String path = buildCollectionPath(weblog, locale, category, dateString, tags, pageNum);
        if (dateString != null) {
        ...
        return buildPreviewURL(weblog, locale, absolute, path, params);
    }
    ...
    public String getWeblogPageURL(Weblog weblog, String locale, String pageLink, String entryAnchor, String category, String dateString, List<String> tags, int pageNum, boolean absolute) {
        ...
        return buildPreviewURL(weblog, locale, absolute, "page/" + pageLink, params);
    }
    ...
    private String buildPreviewURL(Weblog weblog, String locale, boolean absolute, String path, Map<String, String> params) {
    ...
    private String buildCollectionPath(Weblog weblog, String locale, String category, String dateString, List<String> tags, int pageNum) {
        StringBuilder path = new StringBuilder();
        if (category != null && dateString == null) {
            path.append("category/").append(URLUtilities.encodePath(category));
        } else if (dateString != null && category == null) {
            path.append("date/").append(dateString);
        } else if (tags != null && !tags.isEmpty()) {
            path.append("tags/").append(URLUtilities.getEncodedTagsString(tags));
        }
