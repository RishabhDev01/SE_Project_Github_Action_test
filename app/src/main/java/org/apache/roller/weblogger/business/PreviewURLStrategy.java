...
public class PreviewURLStrategy extends MultiWeblogURLStrategy {
    ...
    public String getWeblogResourceURL(Weblog weblog, String filePath, boolean absolute) {
        ...
        return buildWeblogResourceURL(weblog, filePath, absolute, params);
    }
    ...
    private String buildWeblogResourceURL(Weblog weblog, String filePath, boolean absolute, Map<String, String> params) {
        if (weblog == null) {
            return null;
        }
        StringBuilder url = new StringBuilder(URL_BUFFER_SIZE);
