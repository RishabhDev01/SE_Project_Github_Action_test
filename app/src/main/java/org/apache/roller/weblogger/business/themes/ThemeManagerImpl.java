...
public class ThemeManagerImpl implements ThemeManager {
    ...
    public void importTheme(Weblog weblog, SharedTheme theme, boolean skipStylesheet)
        ...
        importTemplates(wmgr, weblog, theme, skipStylesheet);
        importResources(fileMgr, weblog, theme);
        updateWeblogTheme(weblog, wmgr);
    }

    private void importTemplates(WeblogManager wmgr, Weblog weblog, SharedTheme theme, boolean skipStylesheet)
            throws WebloggerException {
