...
public class ThemeManagerImpl implements ThemeManager {
    ...
    public void importTheme(Weblog weblog, SharedTheme theme, boolean skipStylesheet)
        ...
        importTemplates(wmgr, fileMgr, weblog, theme, skipStylesheet);
        importResources(fileMgr, weblog, theme);
        updateWeblogTheme(weblog, wmgr);
    }

    private void importTemplates(WeblogManager wmgr, MediaFileManager fileMgr, Weblog weblog, SharedTheme theme, boolean skipStylesheet)
            throws WebloggerException {
    ...
    private void importResources(MediaFileManager fileMgr, Weblog weblog, SharedTheme theme) throws WebloggerException {
    ...
    private void updateWeblogTheme(Weblog weblog, WeblogManager wmgr) throws WebloggerException {
