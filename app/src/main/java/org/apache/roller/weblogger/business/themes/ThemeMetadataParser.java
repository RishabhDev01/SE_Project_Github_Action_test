...
public class ThemeMetadataParser {
    ...
    public ThemeMetadata unmarshall(InputStream instream)
        ...
        extractPreviewImage(theme, root);
    ...
    private void extractPreviewImage(ThemeMetadata theme, Element root) throws ThemeParsingException {
    ...
    private ThemeMetadataTemplate elementToTemplateMetadata(Element element)
        ...
        extractRenditions(template, element);
        extractNavbarAndHidden(template, element);
        validateTemplate(template);
        return template;
    }

    private void extractRenditions(ThemeMetadataTemplate template, Element element) throws ThemeParsingException {
    ...
    private void extractNavbarAndHidden(ThemeMetadataTemplate template, Element element) {
