...
public class ThemeMetadataParser {
    ...
    public ThemeMetadata unmarshall(InputStream instream)
        ...
        parseThemeMetadata(theme, root);
        
        parsePreviewImage(theme, root);
        
        parseStylesheet(theme, root);
        
        parseStaticResources(theme, root);
        
        parseTemplates(theme, root);
    ...
    private void parseThemeMetadata(ThemeMetadata theme, Element root) {
    ...
    private void parsePreviewImage(ThemeMetadata theme, Element root) throws ThemeParsingException {
    ...
    private void parseStylesheet(ThemeMetadata theme, Element root) throws ThemeParsingException {
    ...
    private void parseStaticResources(ThemeMetadata theme, Element root) {
    ...
    private void parseTemplates(ThemeMetadata theme, Element root) throws ThemeParsingException {
    ...
    private ThemeMetadataTemplate elementToTemplateMetadata(Element element)
        ...
        parseTemplateRenditions(template, element);
        parseTemplateFlags(template, element);
        validateTemplateMetadata(template);
        return template;
    }

    private void parseTemplateRenditions(ThemeMetadataTemplate template, Element element) throws ThemeParsingException {
    ...
    private void parseTemplateFlags(ThemeMetadataTemplate template, Element element) {
    ...
    private void validateTemplateMetadata(ThemeMetadataTemplate template) throws ThemeParsingException {
    ...
    private ThemeMetadataTemplate elementToStylesheet(Element element)
        ...
        parseTemplateRenditions(template, element);
        validateStylesheetMetadata(template);
        return template;
    }

    private void validateStylesheetMetadata(ThemeMetadataTemplate template) throws ThemeParsingException {
        if (StringUtils.isEmpty(template.getName())) {
