...
public class ThemeMetadataParser {
    ...
    public ThemeMetadata unmarshall(InputStream instream)
        ...
        Document doc = parseDocument(instream);
        Element root = doc.getRootElement();
        
        // Extract theme metadata
        extractThemeMetadata(theme, root);
        
        // Extract preview image path
        extractPreviewImagePath(theme, root);
        
        // Extract stylesheet
        extractStylesheet(theme, root);
        
        // Extract static resources
        extractStaticResources(theme, root);
        
        // Extract templates
        extractTemplates(theme, root);
    ...
    private Document parseDocument(InputStream instream) throws JDOMException, IOException {
        SAXBuilder builder = new SAXBuilder();
        return builder.build(instream);
    }

    private void extractThemeMetadata(ThemeMetadata theme, Element root) {
    ...
    private void extractPreviewImagePath(ThemeMetadata theme, Element root) throws ThemeParsingException {
    ...
    private void extractStylesheet(ThemeMetadata theme, Element root) throws ThemeParsingException {
    ...
    private void extractStaticResources(ThemeMetadata theme, Element root) {
    ...
    private void extractTemplates(ThemeMetadata theme, Element root) throws ThemeParsingException {
    ...
    private void validateThemeMetadata(ThemeMetadata theme) throws ThemeParsingException {
    ...
    private ThemeMetadataTemplate elementToTemplateMetadata(Element element)
        ...
        extractTemplateRenditions(template, element);
        extractTemplateFlags(template, element);
        validateTemplate(template);
        return template;
    }

    private void extractTemplateRenditions(ThemeMetadataTemplate template, Element element) throws ThemeParsingException {
    ...
    private void extractTemplateFlags(ThemeMetadataTemplate template, Element element) {
    ...
    private void validateTemplate(ThemeMetadataTemplate template) throws ThemeParsingException {
    ...
    private ThemeMetadataTemplate elementToStylesheet(Element element)
        ...
        extractTemplateRenditions(template, element);
        validateStylesheet(template);
        return template;
    }

    private void validateStylesheet(ThemeMetadataTemplate template) throws ThemeParsingException {
        if (StringUtils.isEmpty(template.getName())) {
