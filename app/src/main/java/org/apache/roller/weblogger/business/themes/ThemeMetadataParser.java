...
public class ThemeMetadataParser {
    ...
    private ThemeMetadataTemplate parseTemplateMetadata(Element element)
    ...
    private ThemeMetadataTemplate parseStylesheet(Element element)
            throws ThemeParsingException {
    ...
    private ThemeMetadataTemplateRendition parseRendition(Element renditionElement)
            throws ThemeParsingException {
