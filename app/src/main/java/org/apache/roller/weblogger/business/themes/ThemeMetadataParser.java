...
public class ThemeMetadataParser {
    ...
    public ThemeMetadata unmarshall(InputStream instream)
        ...
        parsePreviewImage(root, theme);

        // grab the stylesheet if it exists
        parseStylesheet(root, theme);

        // now grab the static resources
        parseResources(root, theme);

        // now grab the templates
        parseTemplates(root, theme);
    ...
    private void parseThemeMetadata(Element root, ThemeMetadata theme) {
    ...
    private void parsePreviewImage(Element root, ThemeMetadata theme) throws ThemeParsingException {
    ...
    private void parseStylesheet(Element root, ThemeMetadata theme) throws ThemeParsingException {
    ...
    private void parseResources(Element root, ThemeMetadata theme) {
    ...
    private void parseTemplates(Element root, ThemeMetadata theme) throws ThemeParsingException {
