...
public class ThemeMetadataParser {
    ...
    public ThemeMetadata unmarshall(InputStream instream)
        ...
        for (Element template : templates) {
            ThemeMetadataTemplate tmpl = parseTemplateMetadata(template);
    ...
    private ThemeMetadataTemplate parseTemplateMetadata(Element element) throws ThemeParsingException {
        ...
        for (Element renditionElement : renditionList) {
            ThemeMetadataTemplateRendition rendition = parseRendition(renditionElement);
    ...
    private ThemeMetadataTemplate parseStylesheet(Element element) throws ThemeParsingException {
        ThemeMetadataTemplate template = new ThemeMetadataTemplate();
    ...
    private ThemeMetadataTemplateRendition parseRendition(Element renditionElement) throws ThemeParsingException {
