...
public class ThemeMetadataParser {
    ...
    public ThemeMetadata unmarshall(InputStream instream)
        ...
        theme = parseThemeMetadata(theme, root);
        ...
        validateThemeMetadata(theme, templates);
    ...
    private ThemeMetadata parseThemeMetadata(ThemeMetadata theme, Element root) {
    ...
    private void validateThemeMetadata(ThemeMetadata theme, List<Element> templates) throws ThemeParsingException {
        ...
        for (Element template : templates) {
            if(ComponentType.WEBLOG.name().equalsIgnoreCase(template.getAttributeValue("action"))) {
    ...
    private ThemeMetadataTemplate elementToTemplateMetadata(Element element)
        ...
        for (Element renditionElement : renditionList) {
            ThemeMetadataTemplateRendition rendition = parseTemplateRendition(renditionElement);
    ...
    private ThemeMetadataTemplateRendition parseTemplateRendition(Element renditionElement) throws ThemeParsingException {
