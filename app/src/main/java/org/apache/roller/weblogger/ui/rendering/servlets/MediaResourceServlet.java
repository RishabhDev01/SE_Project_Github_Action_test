...
public class MediaResourceServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (handleNotModifiedRequest(request, response, mediaFile, resourceRequest)) {
                return;
            }
    ...
    private boolean handleNotModifiedRequest(HttpServletRequest request, HttpServletResponse response, MediaFile mediaFile, WeblogMediaResourceRequest resourceRequest) {
    ...
    private void serveMediaFile(HttpServletResponse response, MediaFile mediaFile, WeblogMediaResourceRequest resourceRequest) {
