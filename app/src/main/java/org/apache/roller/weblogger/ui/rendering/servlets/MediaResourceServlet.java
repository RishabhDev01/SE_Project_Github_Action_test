...
public class MediaResourceServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        MediaFile mediaFile = getMediaFile(mfMgr, resourceRequest);
        if (mediaFile == null) {
            response.sendError(HttpServletResponse.SC_NOT_FOUND);
            return;
        }
    ...
    private MediaFile getMediaFile(MediaFileManager mfMgr, WeblogMediaResourceRequest resourceRequest) {
        try {
