...
public class GlobalConfig extends UIAction implements HttpParametersAware, ServletRequestAware {
    ...
    private void validateProperties() {
        for (String propName : getProperties().keySet()) {
            ...
            PropertyDef propertyDef = getGlobalConfigDef().getPropertyDef(propName);
            ...
            if (propertyDef.getType().equals("boolean")) {
                ...
                validateStringProperty(updProp, incomingProp, propertyDef);
            }
        }
    }
    ...
    private void validateStringProperty(RuntimeConfigProperty updProp, String incomingProp, PropertyDef propertyDef) {
        if (incomingProp != null) {
            updProp.setValue(incomingProp.trim());
            log.debug("Set something " + updProp.getName() + " = " + incomingProp);
    ...
    private void saveUpdatedProperties() throws WebloggerException {
        PropertiesManager mgr = WebloggerFactory.getWeblogger().getPropertiesManager();
