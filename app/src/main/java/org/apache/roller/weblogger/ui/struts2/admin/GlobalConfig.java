...
public class GlobalConfig extends UIAction implements HttpParametersAware, ServletRequestAware {
    ...
    private ConfigDef globalConfigDef;
    private List<WeblogEntryCommentPlugin> pluginsList;
    private String[] commentPlugins;
    ...
    private void updateBooleanProperty(RuntimeConfigProperty updProp, String incomingProp) {
        try {
            ...
            String propDesc = bundle.getString(getGlobalConfigDef().getPropertyDef(updProp.getName()).getKey());
